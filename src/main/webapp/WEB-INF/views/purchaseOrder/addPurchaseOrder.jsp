			...
			<div class="box-title">
				...
				<div class="box-tool">
					<a href="${pageContext.request.contextPath}/addPurchaseOrder">
						ADD PO </a> <a
						href="${pageContext.request.contextPath}/listOfPurachaseOrder">
				...
				<div>
					<form id="submitForm"
								...
								<c:choose>
									<c:when test="${isFromDashBoard==1}">
										<input type="hidden" id="poType" name="poType"
											value="${poTypeTemp}">
										<select name="poTyped" id="poTyped"
											class="form-control chosen" onchange="getInvoiceNo()"
											disabled>
						...
						<div class="box-content">
							...
							<div class="col-md-3">
								<input type="text" id="poNo" name="poNo" value="${code}"
									readonly class="form-control">
							</div>
							<div class="col-md-2">PO Date</div>
							<div class="col-md-3">
								<input type="text" id="poDate" name="poDate" value="${date}"
									class="form-control date-picker" onblur="getInvoiceNo()"
									required>
						...
						<div class="box-content">
							...
							<div class="col-md-3">
								<c:choose>
									<c:when test="${isFromDashBoard==1}">
										...
										<select name="indIdd" id="indIdd" class="form-control chosen"
											disabled>
									...
									<c:otherwise>
										<select name="indId" id="indId"
											onchange="getVendorListByIndId()" class="form-control chosen"
											required>
							...
							<div class="col-md-4">
								...
								<a href="${pageContext.request.contextPath}/editIndent/${indId}"
									title="View/Edit"><span
									class="glyphicon glyphicon-info-sign"></span></a>
							</div>
							<input type="hidden" value="${indentDate}" id="indentDateText"
								name="indentDateText">
						...
						<div class="box-content">
							...
							<div class="col-md-10">
									...
									<c:forEach items="${vendorList}" var="vendorList">
										<c:choose>
											<c:when test="${vendorList.vendorId==vendIdTemp}">
												<option value="${vendorList.vendorId}" selected>${vendorList.vendorName}&nbsp;&nbsp;
								...
								</select> <input type="hidden" id="vendSelectedtext"
									name="vendSelectedtext" value="${vendSelected}">
							</div>
						...
						<div class="box-content">
							...
							<div class="col-md-10">
								<input type="text" placeholder="Remark" value="${remarkTemp}"
									name="poRemark" id="poRemark" class="form-control" required>
						...
						<c:choose>
							<c:when test="${isGeneralPurchase==1}">
								<div class="box-content">
									...
									<div class="col-md-3">
										<input type="text" placeholder="Bill No" name="quotation"
									...
									<div class="col-md-3">
										<input type="text" placeholder="Bill Date"
											value="${quotationDateTemp}" name="quotationDate"
								...
								<div class="box-content">
									...
									<div class="col-md-3">
										<input type="text" placeholder="Enter Quotation No"
											value="${quotationTemp}" name="quotation" id="quotation"
							...
							<div class="col-md-3">
								<select name="deliveryId" id="deliveryId"
									...
									<c:forEach items="${deliveryTermsList}" var="deliveryTermsList">
										<c:choose>
											<c:when
												test="${deliveryTermsList.deliveryTermId==deliveryIdTemp}">
						...
						<div class="box-content">
							...
							<div class="col-md-3">
								...
								<select name="dispatchMode" id="dispatchMode"
									...
									<c:forEach items="${dispatchModeList}" var="dispatchModeList">
										<c:choose>
											<c:when
												test="${dispatchModeList.dispModeId==dispatchModeTemp}">
							...
							<div class="col-md-3">
								<input type="number" placeholder="Order Validity"
									value="${orderValidityTemp}" name="orderValidity"
										...
										<tbody>
											...
											<c:forEach items="${poDetailList}" var="poDetailList"
												...
												<tr>
													...
													<td align="right"><c:out
															value="${poDetailList.itemRate}" /></td>
													...
													<c:choose>
														...
														<c:otherwise>
															...
															<td align="right"><fmt:formatNumber type="number"
																...
																(${poDetailList.sgst}%)
															<td align="right"><fmt:formatNumber type="number"
																	maxFractionDigits="2" value="${poDetailList.taxValue}" />
																(${poDetailList.igst}%)
														</c:otherwise>
													</c:choose>

													<td align="left"><c:out
															value="${poDetailList.schDate}" /></td>
						...
						<div class="box-content">
							...
							<div class="col-md-2">
								<input style="text-align: right; width: 150px" type="hidden"
					...
					<form id="submitList"
						...
						<div id="myModal" class="modal">
							...
							<input type="hidden" value="-" name="quotationTemp"
								id="quotationTemp"> <input type="hidden" value="0"
								name="poTypeTemp" id="poTypeTemp"> <input
								type="hidden" value="0" name="quotationDateTemp"
								id="quotationDateTemp"> <input type="hidden"
								value="0" name="payIdTemp" id="payIdTemp"> <input
								type="hidden" value="0" name="deliveryIdTemp"
								id="deliveryIdTemp"> <input type="hidden" value="0"
								name="dispatchModeTemp" id="dispatchModeTemp"> <input
								type="hidden" value="0" name="poDateTemp" id="poDateTemp">
							<input type="hidden" value="${code}" name="poNoTemp"
								id="poNoTemp"> <input type="hidden" value="1"
								name="orderValidityTemp" id="orderValidityTemp"> <input
								type="hidden" value="${isFromDashBoard}" name="isFromDashBoard"
								id="isFromDashBoard"> <input type="hidden"
								value="${isGeneralPurchase}" name="isGeneralPurchase"
								id="isGeneralPurchase"> <input type="hidden"
								name="remarkTemp" id="remarkTemp">
  ...
  fauxTable.appendChild(clonedElement2);
			...
			$('#submitForm')
					.submit(
							function() {
								...
								var indentDateText = $("#indentDateText").val()
										.split('-');

								var firstDate = new Date();
								firstDate.setFullYear(poDate[2],
										(poDate[1] - 1), poDate[0]);

								var secondDate = new Date();
								secondDate.setFullYear(indentDateText[2],
										(indentDateText[1] - 1),
										indentDateText[0]);
	...
	<script>
		...
		function previeousRecord(itemId, value) {
			...
			$.getJSON('${getPreviousRecordOfPoItem}',
												...
												function(key, itemList) {
													...
													try {
														...
														var balanceQty = parseFloat($(
																"#balanceQty"
																		+ itemList.indDetailId)
																.val());
														if (balanceQty != 0
																&& itemList.qty <= balanceQty) {
															document
																	.getElementById("select_to_approve"
																			+ itemList.indDetailId).checked = true;
															document
																	.getElementById("poQty"
																			+ itemList.indDetailId).value = itemList.qty;
															document
																	.getElementById("balanceQty"
																			+ itemList.indDetailId).value = balanceQty
																	- itemList.qty;
															document
																	.getElementById("rate"
																			+ itemList.indDetailId).value = itemList.rate;
															document
																	.getElementById("indRemark"
																			+ itemList.indDetailId).value = "-";
														}
													} catch (err) {
													...
													function(key, itemList) {
														...
														tr
																.append($(
																		'<td></td>')
																		.html(
																				'<a onclick="previeousRecord('
																						+ itemList.itemId
																						+ ',\''
																						+ itemList.itemCode
																						+ '\')"><div title="'+itemList.itemCode+'">'
																						+ itemList.itemCode
																						+ '</div></a>'));
														...
														if (itemList.poQty > 0) {
																	...
																	.append($(
																			...
																			.html(
																					'<input type="hidden"   id="indQty'+itemList.indDId+'" name="indQty'+itemList.indDId+'" value="'+itemList.indFyr+'" >'
																							+ '<input style="text-align:right; width:120px" type="text" onkeyup="calculateBalaceQty('
																							+ itemList.indDId
																							+ ')" id="poQty'
																							+ itemList.indDId
																							+ '" name="poQty'
															...
															tr
																	.append($(
																			'<td ></td>')
																			.html(
																					'<input style="text-align:right; width:120px" type="text" id="balanceQty'
																							+ itemList.indDId
																							+ '" name="balanceQty'
																							+ itemList.indDId
																							+ '" value="'
																							+ (itemList.indFyr - itemList.poQty)
																							+ '" onchange="checkQty('
																							+ itemList.indDId
														...
														var schDate = itemList.indItemSchddt
																.split("-");
														...
														if (itemList.indRemark == null
															...
															tr
																	.append($(
																			'<td ></td>')
																			.html(
																					'<input style="text-align:right; width:120px" type="hidden" id="disc'
																							+ itemList.indDId
																							+ '" name="disc'
																							+ itemList.indDId
																							+ '" value="0"  class="form-control"  pattern="[+-]?([0-9]*[.])?[0-9]+"   ><input style="text-align:right; width:100px" type="hidden" id="indItemSchd'
																							+ itemList.indDId
																							+ '" name="indItemSchd'
																							+ itemList.indDId
																							+ '" value="'
																							+ itemList.indItemSchd
																							+ '"  class="form-control"  pattern="[+-]?([0-9]*[.])?[0-9]+" required>'
														...
														document
																.getElementById("indMId").value = itemList.indMId;
														$('#table_grid1 tbody')
																.append(tr);
		...
		function requiredAll() {
			...
			if (document.getElementById("allCheck").checked == true) {
				for (var i = 0; i < checkboxes.length; i++) {
					document.getElementById("select_to_approve"
							+ checkboxes[i].value).checked == true;
				...
				for (var i = 0; i < checkboxes.length; i++) {
					document.getElementById("select_to_approve"
							+ checkboxes[i].value).checked == false;
		...
		function getValue() {
			...
			document.getElementById("quotationTemp").value = document
					.getElementById("quotation").value;
			document.getElementById("poTypeTemp").value = document
					.getElementById("poType").value;
			document.getElementById("quotationDateTemp").value = document
					.getElementById("quotationDate").value;
			document.getElementById("payIdTemp").value = document
					.getElementById("payId").value;
			document.getElementById("deliveryIdTemp").value = document
					.getElementById("deliveryId").value;
			document.getElementById("dispatchModeTemp").value = document
					.getElementById("dispatchMode").value;
			document.getElementById("poDateTemp").value = document
					.getElementById("poDate").value;
			document.getElementById("remarkTemp").value = document
					.getElementById("poRemark").value;
			document.getElementById("orderValidityTemp").value = document
					.getElementById("orderValidity").value;
	...
	<script type="text/javascript">
		...
		function getInvoiceNo() {
			...
			$.getJSON('${genrateNo}', {
				...
				document.getElementById("poNo").value = data.message;
				 document.getElementById("poNoTemp").value=data.message;
			});
