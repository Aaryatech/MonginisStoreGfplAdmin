				...
				<div class="col-md-12">
					<div class="box">
						...
						<div class="box-content">
							<form method="post" class="form-horizontal"  action="${pageContext.request.contextPath}/insertIndentPoMrn">
								...
								<div class="row">
									<div class="col-md-12" style="text-align: center"> 
											...
											onclick="getItemcategorywise()" value="Search" type="button" />
											<input class="btn btn-info"
					...
					function(key, data) {
						...
						try {
							...
							tr.append($('<td class="col-sm-1" ></td>').html(key+1));
						  	tr.append($('<td class="col-md-1" ></td>').html(data.itemCode));
						  	tr.append($('<td class="col-md-4" ></td>').html(data.itemDesc));
						  	tr.append($('<td class="col-md-1" ></td>').html(data.itemUom));
						  
						  	
						  	tr.append($('<td class="col-md-1" ></td>').html('<input type=text    class=form-control id= "Qty'+data.itemId+'" name="Qty'+data.itemId+'" value = '+data.itemOpQty+' onchange="changeValues('+data.itemId+')">')); 
						  	tr.append($('<td class="col-md-1" ></td>').html('<input type=text    class=form-control id= "Rate'+data.itemId+'" name="Rate'+data.itemId+'" value = '+data.itemOpRate+' onchange="changeValues('+data.itemId+')">'));
						  	 
						  	tr.append($('<td class="col-md-1" style="text-align: right;"></td>').html('<input type=hidden    class=form-control id= "taxper'+data.itemId+'" name="taxper'+data.itemId+'" value = '+(data.cgstPer + data.sgstPer)+' ">'+(data.cgstPer + data.sgstPer)));
						  	tr.append($('<td class="col-md-1" style="text-align: right;" id="taxableAmt'+data.itemId+'"></td>').html((data.itemOpRate * data.itemOpQty).toFixed(2)));
						  	tr.append($('<td class="col-md-1" style="text-align: right;" id="taxAmt'+data.itemId+'"></td>').html(((data.itemOpRate * data.itemOpQty*(data.cgstPer + data.sgstPer))/100).toFixed(2)));
						  	tr.append($('<td class="col-md-1" style="text-align: right;" id="totalAmt'+data.itemId+'"></td>').html(((data.itemOpRate * data.itemOpQty)+(data.itemOpRate * data.itemOpQty*(data.cgstPer + data.sgstPer))/100).toFixed(2)));
						  	 
						  	 tr
							.append($(
									'<td class="col-md-1" style="text-align: center;"></td>')
									.html(
											"<a href='#' class='action_btn'onclick=deleteIndentItem("+key+")><abbr title='Delete'><i class='fa fa-trash-o  fa-lg'></i></abbr></a>"));  
