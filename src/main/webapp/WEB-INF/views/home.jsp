...
<link rel="icon"
	href="${pageContext.request.contextPath}/resources/img/monginislogo.jpg"
	type="image/x-icon">
<link rel="stylesheet"
...
<body>
	...
	<div class="container" id="main-container">
		...
		<div id="main-content">
											...
											<div class="table-responsive" style="border: 0">
												<table class="table table-advance" id="table">
													...
													<tbody>
														...
														<c:forEach items="${lowReorderItemList}"
															var="lowReorderItemList" varStatus="count">
															<c:choose>
																<c:when
																	test="${categoryList.catId==lowReorderItemList.catId}">
																	<c:set var="flag" value="1" />
																	<tr>
																		<td style="width: 2%;"><input type="checkbox"
																			name="select_to_approve" id="select_to_approve"
																			value="${lowReorderItemList.itemId}" /></td>
																		<td style="width: 2%;"><c:out
																				value="${count.index+1}" /></td>
																		<td class="col-md-1"><c:out
																				value="${lowReorderItemList.itemCode}" /></td>
			...
			<div id="pendingPo" style="display: none;">
				<c:forEach items="${indentListRes}" var="indentList"
					varStatus="count">
					<div class="box">
						<div class="box-content">
							<div class="row">
								...
								<div class="col-md-2">${indentList.indMNo}</div>

								<div class="col-md-2">
									<b>Date:</b>
								</div>
								<div class="col-md-2">${indentList.indMDate}</div>
							...
							<div class="row">
								...
								<div class="col-md-2">${indentList.catDesc}</div>
							</div>
						</div>
						<div class="row">
							<div class="col-md-12">
								...
								<div class="" id="todayslist">
									...
									<div class="box-content">
										...
										<div class="table-responsive"
											style="border: 1px; border: 1px Solid lightblue;">
											<table class="table table-advance" id="table1">
												<thead>
													<tr class="bgpink">
														<th style="width: 2%;">Sr</th>
												...
												<tbody>
													...
													<c:forEach items="${indentList.dashIndentDetailList}"
														var="indent" varStatus="count">
														<tr>
			...
			<div id="pendingMrn" style="display: none;">
				<div class="row">
					<div class="box-content">
																		...
																		if (poList.poStatus == 2) {
																			...
																			tr
																					.append($(
																							...
																							.html(
																									"<a href='${pageContext.request.contextPath}/showAddMrn/"+poList.poType+"/"+poList.vendId+"/"+poList.poId+"/"+poList.poNo+"' title='Add MRN' class='action_btn'><i class='fa fa-plus'></i></a>"));
																		}
