...
<body>
	...
	<c:url var="getItemFromItemListforQuery"
		value="/getItemFromItemListforQuery"></c:url>
							...
							<form id="validation-form" method="post">
									...
									<div class="col-md-4">
										<select data-placeholder="Select RM Name"
											...
											<c:forEach items="${itemList}" var="itemList">
												...
												<option value="${itemList.itemId}">${itemList.itemCode}
													&nbsp;&nbsp;${itemList.itemDesc}</option>
								...
								<div class="form-group">
									<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-5">
										<input type="button" onclick="getItemByItemId()"
								...
								<table class="table table-advance" id="table1">
									<thead>
										<tr class="bgpink">
											...
											<th class="col-md-2" style="text-align: center;">Get
												Query Items</th>
										</tr>
									</thead>
									<tbody>
	...
	<script type="text/javascript">
						...
						.getJSON(
								...
								function(data) {
									...
									tr.append($('<td style="width:2%;" ></td>')
											.html(1));
									tr.append($('<td style="width:3%;"></td>')
											.html(data.itemCode));
									tr.append($('<td class="col-md-5"></td>')
											.html(data.itemDesc));
									tr.append($('<td style="width:3%;"></td>')
											.html(data.itemUom));
									tr
											.append($(
													...
													.html(
															' <a href="#" onclick="getQueryItemDetail('
																	+ data.itemId
																	+ ' ,1)" data-toggle="tooltip" title="Indent Items">'
																	+ '<span class="glyphicon glyphicon-th"></span></a>&nbsp;&nbsp;&nbsp; '
																	+ '<a href="#" onclick="getQueryItemDetail('
																	+ data.itemId
																	+ ',2)" data-toggle="tooltip" title="PO Items"><span class="glyphicon glyphicon-th"></span></a>&nbsp;&nbsp;&nbsp;'
																	+ '<a href="#" onclick="getQueryItemDetail('
																	+ data.itemId
																	+ ',3)" data-toggle="tooltip" title="MRN Items"><span class="glyphicon glyphicon-th"></span></a>&nbsp;&nbsp;&nbsp;'
																	+ '<a href="#" onclick="getQueryItemDetail('
																	+ data.itemId
																	+ ',4)" data-toggle="tooltip" title="Returnabel/NonReturnable Items"><span class="glyphicon glyphicon-th"></span></a>&nbsp;&nbsp;&nbsp;'
																	+ '<a href="#" onclick="getQueryItemDetail('
																	+ data.itemId
																	+ ',6)" data-toggle="tooltip" title="Issue Items"><span class="glyphicon glyphicon-th"></span></a>&nbsp;&nbsp;&nbsp; '
																	+ '<a href="#" onclick="getQueryItemDetail('
																	+ data.itemId
																	+ ',8)" data-toggle="tooltip" title="Enquiry Items"><span class="glyphicon glyphicon-th"></span></a>&nbsp;&nbsp;&nbsp;'
																	+ '<a href="#" onclick="getQueryItemDetail('
																	+ data.itemId
																	+ ',9)" data-toggle="tooltip" title="Rejection Memo Items"><span class="glyphicon glyphicon-th"></span></a>&nbsp;&nbsp;&nbsp;'
																	+ '<a href="#" onclick="getQueryItemDetail('
																	+ data.itemId
																	+ ',10)" data-toggle="tooltip" title="Damaged Items"><span class="glyphicon glyphicon-th"></span></a>&nbsp;&nbsp;&nbsp;'));
		...
		function genPdf() {
			window
					.open('${pageContext.request.contextPath}/itemListPdf/'
							+ "0");
