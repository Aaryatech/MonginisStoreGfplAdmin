							...
							<form
								...
								<div class="form-group">
									...
									<input type="hidden" name="itemId" id="itemId"> <input
										...
										type="hidden" name="isItem" id="isItem" value="1">
								...
								<div class="form-group">
									...
									<div class="col-sm-6 col-lg-2 controls">
										<input class="form-control date-picker" id="dp2" size="16"
											type="text" name="curr_rate_date" value="${currentDate}"
												...
												<tbody>
													<c:forEach items="${supplierLists}" var="supplier"
														...
														<tr>
															...
															<td align="left"><c:out value="${supplier.suppName}" /></td>

															<td align="left"><c:out value="${supplier.suppMob1}" /></td>

															<td align="left"><c:out value="${supplier.suppCity}" /></td>
															<td align="left"><c:out
